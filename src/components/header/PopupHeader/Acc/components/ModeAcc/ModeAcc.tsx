...
const ModeAcc = () => {
    return(
        <React.Fragment>
            {dataAcc.map((it) => {
                return(
                    <div className="flex w-[95%] m-auto h-[52px] items-center hover:bg-[#f2f2f2] rounded-[10px]">
                        <div className="w-[36px] h-[36px] flex items-center justify-center my-[8px] mr-[12px] ml-[10px] rounded-[50%] bg-[#e1e3e8]">
