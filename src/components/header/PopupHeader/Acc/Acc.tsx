    ...
    return(
        <section className="absolute bg-[#ffffff] w-[360px] max-h-[632px] top-[-4px] right-[-4px] rounded-[15px] shadow-2xl ">
            <div className="bg-[#ffffff] w-[93%] m-auto mt-[12px] mb-[16px] rounded-[10px] shadow-xl">
                <div className="flex w-[95%] m-auto h-[60px] items-center hover:bg-[#f2f2f2] rounded-[10px]">
                    <Link to="/profile" className="flex w-[100%] hover:text-black">
                        <div>
                        ...
                        <div className="flex justify-center items-center">
                            <span className="text-[18px] font-semibold px-[10px]">Nguyễn Đức Trọng</span>
                        </div>
                    </Link>
                </div>
                <hr className="mx-[16px] text-[#ced0d4] border-[1px]"/>
                <div className="w-[95%] m-auto py-[8px] hover:bg-[#f2f2f2] cursor-pointer rounded-[10px]">
                    <p className="p-[4px] text-[16px] font-medium text-[#227cf3]">Xem tất cả trang cá nhân</p>
                </div>
            </div>
            <div>
                <ModeAcc/>
