...
const menuLeft = () => { 
    return(
        ...
        //     {dataMenuLeft.map((it)=>{
        //         return(
        //             <div key={it.id} className="flex w-[95%] h-fit pb-[10px] m-auto hover:bg-[#f2f2f2] rounded-[10px] cursor-pointer">
        ...
        <React.Fragment>
            {dataMenuLeft.map((it)=>{
                return(
                    <div key={it.id}
                        className="flex w-[340px] h-fit pb-[10px] pr-[10px] ml-[15px] hover:bg-[#f2f2f2] rounded-[10px] cursor-pointer">
                        <div className="w-[36px] h-[36px] mt-[4px] mr-[12px] mb-[8px]">
                            <img className="max-w-[36px]" src={it.img} alt="" />
                        </div>
                        <div>
