...
import Messenger from './SubLayOut/Messenger/Messenger';
import Notification from './SubLayOut/Notification/Notification';
...
const LayoutPage = ({ children }: any) => {
    ...
    const handlePopUpMess = () => {
        setToggleNotifi(false)
        setToggleMess(!toggleMess)
      }
    const handlePopupNotifi = () => {
        setToggleMess(false)
        setToggleNotifi(!toggleNotifi)
    }


    return (
        <div>
            <header className="bg-[#ffffff] flex justify-between h-[56px] items-center w-[97%] m-[auto]">
                ...
                <div className='flex relative'>
                    <ul className='flex'>
                        ...
                        <li className='flex items-center'>
                            <span className="absolute left-[62px]">
                                <BsSearchHeartFill className="text-[16px]"/>
                            </span>
                            <input className="w-[240px] rounded-[20px] h-[40px] pl-[35px] bg-[#f0f2f5]"
                                type="text" 
                ...
                <div className='flex'>
                    <ul className='flex'>
                        <li className='flex w-[40px] h-[40px] rounded-[50%] bg-[#e2e4e9] justify-center items-center mx-[5px]' title="Menu">
                            <a href="">
                        ...
                        <li className='flex justify-center items-center w-[40px] h-[40px] rounded-[50%] bg-[#e2e4e9] relative mx-[5px]' onClick={handlePopUpMess}>
                            ...
                            <div className={`${toggleMess ? "block" : "hidden"}`}>
                                <Messenger />
                            </div>
                        </li>
                        <li className='flex justify-center items-center w-[40px] h-[40px] rounded-[50%] bg-[#e2e4e9] mx-[5px]' onClick={handlePopupNotifi}>
                            ...
                            <div className={`${toggleNotifi ? "block" : "hidden"}`}>
                                <Notification/>
                            </div>
                        </li>
                        <li className='w-[50px] mx-[5px]'>
                            <div className='w-[40px]'>
                                <img className='w-[40px] rounded-[50%]' src="https://scontent.fhan2-5.fna.fbcdn.net/v/t39.30808-1/351469982_1435353713673053_2527717267963048920_n.jpg?stp=c0.0.60.60a_cp0_dst-jpg_p60x60&_nc_cat=109&ccb=1-7&_nc_sid=7206a8&_nc_ohc=kWp4CsLK2EAAX8hcZ50&_nc_ht=scontent.fhan2-5.fna&oh=00_AfAK-DuhyQ-V_3VH_NZsrD7LsIgGWbvy0zj93aHBq-x2hg&oe=64F059EF" alt="" />
                            </div>
                        </li>
                    </ul>
                </div>
